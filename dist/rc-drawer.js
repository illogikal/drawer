...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Drawer__ = __webpack_require__(7);
...
var Drawer = function (_React$PureComponent) {
  ...
  _createClass(Drawer, [{
    ...
    value: function render() {
      ...
      return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_dom__["createPortal"])(children, this.container);
    }
  }]);
...
Drawer.propTypes = {
  ...
  bodyStyle: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.object,
  defaultOpen: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.bool,
  placement: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
  level: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.oneOfType([__WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string, __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.array]),
  levelTransition: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
  getContainer: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
  handleChild: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.any,
  ...
  onMaskClick: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func,
  onHandleClick: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func,
  showMask: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.bool,
  maskStyle: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.object
};
Drawer.defaultProps = {
  className: '',
  prefixCls: 'drawer',
  ...
  handleChild: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: 'drawer-handle-icon' }),
  handleStyle: {},
  showMask: true,
  maskStyle: {}
};
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getParentAndLevelDom = function (props) {
    ...
    if (level === 'all') {
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils__["a" /* dataToArray */])(level).forEach(function (key) {
  ...
  this.trnasitionEnd = function (e) {
    var dom = e.target;
    dom.removeEventListener(__WEBPACK_IMPORTED_MODULE_4__utils__["b" /* transitionEnd */], _this3.trnasitionEnd);
  ...
  this.setLevelDomTransform = function (open, openTransition, placementName, value) {
    ...
    _this3.levelDom.forEach(function (dom) {
      if (_this3.isOpenChange || openTransition) {
        ...
        dom.addEventListener(__WEBPACK_IMPORTED_MODULE_4__utils__["b" /* transitionEnd */], _this3.trnasitionEnd);
      }
  ...
  this.getChildToRender = function () {
    ...
    var wrapperClassname = __WEBPACK_IMPORTED_MODULE_3_classnames___default()(prefixCls, (_classnames = {}, _defineProperty(_classnames, prefixCls + '-' + placement, true), _defineProperty(_classnames, prefixCls + '-open', open), _defineProperty(_classnames, className, !!className), _classnames));
    ...
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      showMask && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', {
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        handleChild && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          {
